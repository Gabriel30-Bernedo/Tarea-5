...
```
    ...
    ## 
    ## =========== Homogenization of Tmax, 2001-2003. (Thu Jan 27 23:27:31 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 0.19 secs 
    ## 
    ## ----------- Final computations:
    ## 
...
```
    ...
    ## 
    ## =========== Homogenization of Ptest, 1965-2005. (Thu Jan 27 23:27:31 2022)
    ## 
    ...
    ## HOMOGEN() APPLICATION OUTPUT  (From R's contributed package 'climatol' 3.1.1)
    ## 
    ## =========== Homogenization of Ptest-1, 1965-2005. (Thu Jan 27 23:27:31 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 8.73 secs 
    ## 
    ## ----------- Final computations:
    ## 
    ## ACmx: Station maximum absolute autocorrelations of anomalies
    ...
    ## 
    ## 
    ## ======== End of homogenization of overlapping areas, after 8.9 secs 
    ## 
    ## ----------- Generated output files: -------------------------
    ## 
...
```
    ...
    ## File C:/Users/gabriel/Documents/Ptest_1965-2005_m.nc (NC_FORMAT_CLASSIC):
    ## 
...
![](Tarea-climatol_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
